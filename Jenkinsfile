  ...
  stages {
    ...
    steps {
        ...
        withEnv([
            ...
            docker build -t danish06/movie-streaming-backend-nodejs:latest .
            docker push danish06/movie-streaming-backend-nodejs:latest
            docker build -t danish06/movie-streaming-frontend:latest ./html
            docker push danish06/movie-streaming-frontend:latest
            docker logout
            '''
        }
        }
